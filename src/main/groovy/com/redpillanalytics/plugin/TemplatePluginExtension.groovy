...
class TemplatePluginExtension {
   ...
   def isUsableConfiguration(Project project, String configuration, String regexp) {
   ...
   def getParameter(Project project, String name, String extension, String defaultValue = null) {
